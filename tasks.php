  ...
  <div class="col-md-12 ORDER_post" ng-repeat='x in ALLDATA_list[1].orders | filter:search | orderBy:"-id"' ng-show="x.freelancer_id==USER_id">
    <div class="post">
      <!-- ORDER NAME  -->
    ...
    <hr>
    <b><a href="#">{{ getUserTitleByID(x.freelancer_id) }}</a> - in developing this projcet</b>
